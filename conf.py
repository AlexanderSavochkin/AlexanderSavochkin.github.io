...
BLOG_AUTHOR = "Alex Savochkin"  # (translatable)
BLOG_TITLE = "Alex Savochkin"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://alexandersavochkin.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://alexandersavochkin.github.io/"
BLOG_EMAIL = "alexandr.savochkin@gmail.com"
BLOG_DESCRIPTION = "I write about a variety of topics, primarily focusing on programming, embedded systems, do-it-yourself (DIY) projects, robotics, and machine learning (ML)."  # (translatable)
